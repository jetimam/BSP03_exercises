...
public class Main
{
	...
	{
		Dictionary<String, ArrayList<Neighbor>> map = new Hashtable<String, ArrayList<Neighbor>>();

		map = MapInitializer(map);
	}

	public static Dictionary<String, ArrayList<Neighbor>> MapInitializer(Dictionary<String, ArrayList<Neighbor>> map)
	{
